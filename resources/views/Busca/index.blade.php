...
@section('scriptlocal')
    ...
    <script type="text/javascript">
            ...
            $radiosMarca.change(function () {
                ...
                $.ajax({
                    ...
                    $.each(JSON.parse(json), function (i, obj) {
                        ...
                        html_code+="                    <a href='http://www.cadeoproduto.com.br/busca/"+obj.id+"' class='product-title'> "+obj.descricao ;
        ...
        function is_img(cdBarras) {
            ...
            img.src = "http://www.cadeoproduto.com.br/imgProdutos/"+cdBarras+".jpg";

            img.onload = function() {

                $('#'+cdBarras).attr("src","http://www.cadeoproduto.com.br/imgProdutos/"+cdBarras+".jpg")


            }
            img.onerror = function() {
                $('#'+cdBarras).attr("src","http://www.cadeoproduto.com.br/assets/img/image_placeholder.jpg")
